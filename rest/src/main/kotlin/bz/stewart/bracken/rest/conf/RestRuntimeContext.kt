...
class RestRuntimeContext(servingPort:Int, client: DatabaseClient<MongoClient>) : RuntimeContext {
    override val servingPort: Int = servingPort
    override val client: DatabaseClient<MongoClient> = client
    ...
    class Builder {
        ...
        fun setClientFromProps(properties: FileProperties<RestDefaultProperties>):Builder {
            //TODO move this into a runtime context class
