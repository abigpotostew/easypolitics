...
class Color(var red: Double, var green: Double, var blue: Double, var alpha: Double = 1.0) {
    companion object {
        ...
        fun fromHex(s : String) : Color {
            ...
            if (s.length == 4 && s[0] == '#') {
                val r = s.substring(1, 2).toInt(16)
                val g = s.substring(2, 3).toInt(16)
                val b = s.substring(3, 4).toInt(16)
            ...
            if (s.length == 5 && s[0] == '#') {
                ...
                val g = s.substring(2, 3).toInt(16)
                val b = s.substring(3, 4).toInt(16)
                val a = s.substring(4, 5).toInt(16)
            ...
            if (s.length == 9 && s[0] == '#') {
                ...
                val g = s.substring(3, 5).toInt(16)
                val b = s.substring(5, 7).toInt(16)
                val a = s.substring(7, 9).toInt(16)
