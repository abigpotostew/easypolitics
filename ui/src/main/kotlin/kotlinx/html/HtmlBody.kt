...
inline fun HtmlBodyTag.button(c: CssClass, contents: BUTTON.() -> Unit) = contentTag(BUTTON(this), c, contents)
...
inline fun HtmlBodyTag.h5(c: CssClass, contents: H5.() -> Unit) = contentTag(H5(this), c, contents)

inline fun HtmlBodyTag.h6(c: String, contents: H6.() -> Unit) = contentTag(H6(this), c, contents)
inline fun HtmlBodyTag.h6(contents: H6.() -> Unit) = contentTag(H6(this), contents)

inline fun HtmlBodyTag.h7(c: String, contents: H7.() -> Unit) = contentTag(H7(this), c, contents)
inline fun HtmlBodyTag.h7(contents: H7.() -> Unit) = contentTag(H7(this), contents)
...
inline fun HtmlBodyTag.img(c: CssClass, contents: IMG.() -> Unit) = contentTag(IMG(this), c, contents)
...
inline fun HtmlBodyTag.a(c: CssClass, contents: A.() -> Unit) = contentTag(A(this), c, contents)
...
inline fun HtmlBodyTag.div(c: CssClass, contents: DIV.() -> Unit) = contentTag(DIV(this), c.label(), contents)
...
inline fun HtmlBodyTag.p(c: CssClass, contents: P.() -> Unit) = contentTag(P(this), c.label(), contents)
...
open class H7(containingTag: HtmlBodyTag) : HtmlBodyTag(containingTag, "h7")
